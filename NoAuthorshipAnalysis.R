...
low_task1 <- data.frame(sapply(low_task1[,4:no_colLow],  blank2na))
low_task2 <- data.frame(sapply(low_task2[,4:no_colLow],  blank2na))
low_task3 <- data.frame(sapply(low_task3[,4:no_colLow],  blank2na))
